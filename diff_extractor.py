...
class ASTCodeAnalyzer(ICodeAnalyzer):
    ...
    def get_enclosing_node(self, source_code: str, target_line: int) -> Optional[ast.AST]:
        ...
        try:
            ...
            raise CodeAnalysisError(f"Failed to analyze code structure: {str(e)}")
    ...
    def extract_node_source(self, source_code: str, node: ast.AST) -> Optional[str]:
        ...
        try:
            ...
            raise CodeAnalysisError(f"Failed to extract source segment: {str(e)}")
    ...
    def _print_unique_functions(self, source_code: str, added_lines: List[AddedLine]) -> None:
        ...
        for added_line in added_lines:
            ...
            if src and src not in printed_funcs:
                ...
                try:
                    normalized = normalize_code(src)
                    print(normalized)
                    # print(src)
                except Exception as e:
                    print(f"Warning: Could not normalize code: {str(e)}")
                    print(src)
                print("===")
...
class PRAnalyzerConfig:
    ...
    def __init__(self):
        ...
        self.github_token = "your_github_token_here"  # Replace with your GitHub token
